    ...
    if (VRS && VRS.globalDispatch && VRS.serverConfig) {
		...
		///////////////////////////////////////////////////////////
                ...
                VRS.globalOptions.aircraftMarkers.unshift(new VRS.AircraftMarker({
                    ...
                    matches: function( /** VRS.Aircraft */ aircraft) {
                        return aircraft.modelIcao.val === 'GALX' || aircraft.modelIcao.val === 'G200' || aircraft.modelIcao.val === 'CL30' || aircraft.modelIcao.val === 'CL35' || aircraft.modelIcao.val === 'CL60' || aircraft.modelIcao.val === 'C750' || aircraft.modelIcao.val === 'C56X' || aircraft.modelIcao.val === 'BE40' && aircraft.isMlat.val
                    }
                }));
